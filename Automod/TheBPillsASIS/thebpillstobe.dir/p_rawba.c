...
// Build: 14.6.0.5
// Model name:	finalprojecttobe4
// Model path:	C:\Users\grandediw\Desktop\finalprojecttobe4.dir\
// Generated:	Sun Jan 28 20:10:29 2024
...
Label1: ;  // Step1
	{
		{
			LdSetType(thisObj, &(am2_L_rawB[ValidIndex("am_model.am_L_rawB", CurProcIndex(), 4)]));
