...
initglobs0(void)
{
	...
	am_model.am_forklift.am_fork = symGetSystemDataByName(am_model.am_forklift.$sys, "fork");
	...
	am_model.am_conv.am_sta_B3 = symGetSystemDataByName(am_model.am_conv.$sys, "sta_B3");
	...
	am_model.am_conv.am_sta_B4 = symGetSystemDataByName(am_model.am_conv.$sys, "sta_B4");
	...
	am_model.am_V_count_pow$var = symGetSystemDataByName(am_model.$sys, "V_count_pow");
	am_model.am_V_count_pow$var->data = (void*)&am_model.am_V_count_pow;
	...
	am_model.am_V_count_pills = (int32*)xcalloc(5, sizeof(*am_model.am_V_count_pills));
